    ...
    def test_owasp_api7_2023_server_side_request_forgery(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "API7:2023" not in analysis_type:
                    self.log_test("OWASP API7-2023", False, f"Incorrect analysis type: {analysis_type}")
                    return False
    ...
    def test_owasp_api9_2023_improper_inventory_management(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "API9:2023" not in analysis_type:
                    self.log_test("OWASP API9-2023", False, f"Incorrect analysis type: {analysis_type}")
                    return False
