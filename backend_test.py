    ...
    def test_owasp_api3_2023_broken_object_property_level_authorization(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "API3:2023" not in owasp_category:
                    self.log_test("OWASP API3-2023", False, f"Incorrect OWASP category: {owasp_category}")
                    return False
    ...
    def test_owasp_api6_2023_unrestricted_sensitive_business_flows(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "API6:2023" not in owasp_category:
                    self.log_test("OWASP API6-2023", False, f"Incorrect OWASP category: {owasp_category}")
                    return False
